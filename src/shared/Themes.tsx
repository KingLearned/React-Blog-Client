...
const Themes = () => {
  ...
  return (
    ...
    onClick={() => (setGoDark('True'),setKey())}
        className="h-6 w-6 p-1 rounded-full cursor-pointer bg-black text-white"
        fill="currentColor"
        viewBox="0 0 20 20"
    ...
    <svg id="theme-toggle-light-icon" 
        ...
        className="h-6 w-6 p-1 rounded-full cursor-pointer bg-gray-400 text-white" fill="currentColor"
        viewBox="0 0 20 20"
        xmlns="http://www.w3.org/2000/svg" >
